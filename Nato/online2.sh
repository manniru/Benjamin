...
LATGEN_OPTIONS="--config=exp/tri3_online/conf/online_decoding.conf --max-active=7000 --beam=40.0 --lattice-beam=6.0 --acoustic-scale=0.05 --word-symbol-table=$WORD_TABLE --model=$FINAL_MDL"
