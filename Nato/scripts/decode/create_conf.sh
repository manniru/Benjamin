...
LATGEN_OPTIONS="--max-active=7000 --beam=13.0 --lattice-beam=6.0 --acoustic-scale=$ACS_LATGEN --determinize-lattice=true --allow-partial=false --word-symbol-table=$WORD_TABLE $FINAL_MDL $HCLG_FST"
