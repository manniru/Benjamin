...
void
KdOnlineLDecoder::MakeLattice(const Token *start,
                              const Token *end,
...
bool
KdOnlineLDecoder::PartialTraceback(fst::MutableFst<LatticeArc> *out_fst) {
    UpdateImmortalToken();
...
void
KdOnlineLDecoder::FinishTraceBack(fst::MutableFst<LatticeArc> *out_fst) {
    Token *best_tok = NULL;
...
void
KdOnlineLDecoder::TracebackNFrames(int32 nframes,
...
KdOnlineLDecoder::DecodeState
KdOnlineLDecoder::Decode(DecodableInterface *decodable) {
